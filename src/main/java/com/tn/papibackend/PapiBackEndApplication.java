...
public class PapiBackEndApplication {
    ...
    CommandLineRunner run(userService userserv)
    {
        ...
        return args->{
            ...
            userserv.saveUser(new User((Long) null,"Ahmed marzouk","marzouk.ahmed@esprit.tn","1234", 51157780L,datt,"ahmedl17",new ArrayList<>(),new HashSet<>(),new HashSet<>()));
            userserv.saveUser(new User((Long) null,"nada marzouk","marzouk.nada@esprit.tn","56789", 51157780L,datt,"nadal17",new ArrayList<>(),new HashSet<>(),new HashSet<>()));
            userserv.saveUser(new User((Long) null,"mohamed marzouk","mohamed.ahmed@esprit.tn","4321", 51157780L,datt,"mohamedl17",new ArrayList<>(),new HashSet<>(),new HashSet<>()));
